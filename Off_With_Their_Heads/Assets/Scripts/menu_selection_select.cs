...
public class menu_selection_select : MonoBehaviour
{
    ...
    void Update()
    {
        if (is_coop)
        {
            Control_Selection(KeyCode.A, KeyCode.D, KeyCode.Space, ref lock_p1, ref index_col_p1, ref data_p1);
            Control_Selection(KeyCode.LeftArrow, KeyCode.RightArrow, KeyCode.Return, ref lock_p2, ref index_col_p2, ref data_p2);
        }
        else
        {
            Control_Selection(KeyCode.A, KeyCode.D, KeyCode.Space, ref lock_p1, ref index_col_p1, ref data_p1);
    ...
    void Control_Selection(KeyCode left, KeyCode right, KeyCode select, ref bool lock_p, ref int index_col_p, ref List<string> data_p)
    {
        if (!lock_p)
        {
            ...
            else if (Input.GetKeyDown(select))
            {
                ...
                Check_Lock(ref lock_p, ref lock_p1, ref lock_p2, ref count_enter, ref index_col_p, ref index_row);
            }
        }
    }
    ...
    void Check_Lock(ref bool lock_p, ref bool lock_p1, ref bool lock_p2, ref int count_enter, ref int index_col_p, ref int index_row)
    {
        if (is_coop)
        {
            lock_p = true;
